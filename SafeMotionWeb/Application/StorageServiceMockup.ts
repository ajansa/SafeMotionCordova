    ...
    export class StorageServiceMockup implements StorageServiceInterface {
        ...
        constructor() {
            ...
            if (this._listViewData == null) {
                ...
                this._listViewData.push(new ListViewModel("id0001", "FirstName" + ++i, "LastName" + i, 20 * i, 5 * i, i));
                this._listViewData.push(new ListViewModel("id0002", "FirstName" + ++i, "LastName" + i, 20 * i, 5 * i, i));
                this._listViewData.push(new ListViewModel("id0003", "FirstName" + ++i, "LastName" + i, 20 * i, 5 * i, i));
                this._listViewData.push(new ListViewModel("id0004", "FirstName" + ++i, "LastName" + i, 20 * i, 5 * i, i));
            }
